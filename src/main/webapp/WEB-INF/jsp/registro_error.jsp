    ...
    <body class="cuerpo">
        ...
        <fieldset class="center_form gris_oscuro">
            ...
            <form method="post" action="reenviar_contrasinal.htm">
                <a class="articulo"><fmt:message key="reg_error_02"/></a>
                <br><br>
                <a class="articulo tab"><fmt:message key="reg_msg_03"/></a>
                <br>
                <input name="email" type="email" class="recordar_email" style="width:250px;background: ghostwhite" value="${email}" readonly>
                <br>
                <a class="articulo tap"><fmt:message key="reg_msg_04"/></a>
                <br>
                <input name="usuario" type="text" maxlength="45" class="recordar_usuario" style="width:250px;background: ghostwhite" value="${usuario}" readonly>
                <br>

                <button class="button blue" title=""><fmt:message key="msg_header_01"/></button>
            </form>
        </fieldset>
