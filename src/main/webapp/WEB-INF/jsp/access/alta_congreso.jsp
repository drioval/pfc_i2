...
<html>
    ...
    <body class="cuerpo">
        ...
        <fieldset class="center_form gris_oscuro">
            <legend class="subtitulo"><fmt:message key="alta_congreso01"/></legend>
            <br>
            <form method="post" action="alta_congreso.htm" id="alta_congreso">

                <a class="articulo"><fmt:message key="alta_congreso02"/></a>
                <br><br>
                <a class="articulo"><fmt:message key="nombre_congreso"/></a>
                <br>
                <input name="nome_congreso" type="congreso" maxlength="250" style="width:600px;" required="true">
                <br>
