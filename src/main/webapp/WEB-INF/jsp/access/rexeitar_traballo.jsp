...
<html>
    ...
    <body class="cuerpo">
        ...
        <fieldset class="center_form gris_oscuro">
            ...
            <br>
            <form method="post" action="rexeitar_traballo.htm" id="alta_traballo">
                ...
                <c:if test="${idEstadoTraballo != 4}">
                    <input type="submit" formaction="rexeitar_traballo.htm?id=${idTraballo}" class="button blue" value="<fmt:message key="rechazar"/>">
                </c:if>
