...
<html>
    ...
    <body class="cuerpo">
        ...
        <fieldset class="center_form gris_oscuro">
            ...
            <br>
            <form method="post" action="aceptar_traballo.htm" id="alta_traballo">
                ...
                <c:if test="${idEstadoTraballo != 3}">
                    <input type="submit" formaction="aceptar_traballo.htm?id=${idTraballo}" class="button blue" value="Aceptar">
                </c:if>
