...
<html>
    ...
    <body class="cuerpo">
        ...
        <fieldset class="center_form gris_oscuro">
            <legend class="subtitulo"><fmt:message key="confirmar_traballo01"/></legend>
            <br>
            <form method="post" action="accion_confirmar_traballo.htm" id="alta_traballo">
                <input name="idTraballo" type="hidden" value="${idTraballo}">
                <a class="articulo"><fmt:message key="confirmar_traballo02"/></a>
                <br><br>
                <a class="articulo"><fmt:message key="nome_traballo"/></a>
                <br>
                <input name="nome_traballo" type="congreso" maxlength="250" style="width:600px;" required="true" readonly  value="${nomeTraballo}">
                <br>
                <a class="articulo"><fmt:message key="categoria"/></a>
                <br>
                <select name="categoria" id="categoria" required="">
                    <option value="${idCategoria}" selected r>${categoria} - Actual</option>
                </select>
                <br>
                ...
                <br><br>
                <button type="submit" class="button blue" value="Submit"><fmt:message key="confirmar"/></button>
